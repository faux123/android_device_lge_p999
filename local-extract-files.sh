...
# Wifi
cp system/etc/wl/nvram.txt ../../../vendor/$VENDOR/$DEVICE/proprietary/etc/wl
cp system/etc/wl/rtecdc-apsta.bin ../../../vendor/$VENDOR/$DEVICE/proprietary/etc/wl
cp system/etc/wl/rtecdc-mfgtest.bin ../../../vendor/$VENDOR/$DEVICE/proprietary/etc/wl
cp system/etc/wl/rtecdc.bin ../../../vendor/$VENDOR/$DEVICE/proprietary/etc/wl

# OMX
cp system/lib/libdivxdrm.so ../../../vendor/$VENDOR/$DEVICE/proprietary/lib
cp system/lib/liblge_divxdrm.so ../../../vendor/$VENDOR/$DEVICE/proprietary/lib
...
cp system/lib/libsecureclock.so ../../../vendor/$VENDOR/$DEVICE/proprietary/lib
cp system/lib/libstagefrighthw.so ../../../vendor/$VENDOR/$DEVICE/proprietary/lib
cp system/lib/libbridge.so ../../../vendor/$VENDOR/$DEVICE/proprietary/lib
cp system/etc/flex/flex.db ../../../vendor/$VENDOR/$DEVICE/proprietary/etc/flex
cp system/etc/flex/flex.xml ../../../vendor/$VENDOR/$DEVICE/proprietary/etc/flex
cp system/etc/firmware/BCM4329B1_002.002.023.0735.0745.hcd ../../../vendor/$VENDOR/$DEVICE/proprietary/etc/firmware
cp system/bin/motion ../../../vendor/$VENDOR/$DEVICE/proprietary/bin
...
cp system/lib/lge-ril.so ../../../vendor/$VENDOR/$DEVICE/proprietary/lib
cp system/lib/libnvapputil.so ../../../vendor/$VENDOR/$DEVICE/proprietary/lib
...
cp system/lib/libnvmm_logger.so ../../../vendor/$VENDOR/$DEVICE/proprietary/lib
...
cp system/lib/libganril.so ../../../vendor/$VENDOR/$DEVICE/proprietary/lib
cp system/lib/libkineto.so ../../../vendor/$VENDOR/$DEVICE/proprietary/lib
cp system/lib/librilswitch.so ../../../vendor/$VENDOR/$DEVICE/proprietary/lib
